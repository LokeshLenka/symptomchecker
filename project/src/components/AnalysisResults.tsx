...
export const AnalysisResults: React.FC<Props> = ({ result }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Urgency Alert */}
      <div className={`${urgencyConfig.bgColor} ${urgencyConfig.borderColor} border-2 rounded-xl p-6`}>
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <div className={`${urgencyConfig.textColor} bg-white bg-opacity-70 rounded-lg p-4`}>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-xl p-6">
            ...
            <div className="mt-4 p-3 bg-purple-100 rounded-lg">
              <p className="text-purple-700 text-sm font-medium">
                ...
                These are potential conditions based on reported symptoms. Only a healthcare professional can provide an accurate diagnosis.
              </p>
            </div>
          </div>
        )}
      ...
      <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-6">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <p className="text-indigo-700 text-sm">Follow emergency recommendations if urgent</p>
          </div>
          <div className="text-center">
            <div className="bg-indigo-100 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2">
            ...
            <p className="text-indigo-700 text-sm">Monitor symptoms and apply self-care measures</p>
          </div>
          <div className="text-center">
            <div className="bg-indigo-100 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2">
            ...
            <p className="text-indigo-700 text-sm">Schedule medical consultation if needed</p>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="mt-3 p-3 bg-yellow-100 border border-yellow-300 rounded-lg">
              <p className="text-yellow-800 text-sm font-medium">
                ...
                Always trust your instincts. If you feel something is seriously wrong, seek immediate medical attention regardless of this analysis.
              </p>
            </div>
          </div>
        </div>
